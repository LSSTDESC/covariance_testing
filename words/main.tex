...
\figref{eig_snr} shows the results obtained after "removing'' the 200 modes with the largest eigenvalues (by multiplying those eigenvalues by a very large number). 
\textcolor{red}{
